  ...
  grunt.initConfig({
    ...
    concat: Object.assign({}, {
      dist: {
        files: [{
          ...
          '<%= meta.build %>js/libs.js': ['<%= meta.scripts %>libs/jquery-2.1.4.js', '<%= meta.scripts %>libs/handlebars-v4.0.5.js', '<%= meta.scripts %>libs/plugins/*.js', '<%= meta.scripts %>libs/plugins/bootstrap/transition.js', '<%= meta.scripts %>libs/plugins/bootstrap/alert.js', '<%= meta.scripts %>libs/plugins/bootstrap/button.js', '<%= meta.scripts %>libs/plugins/bootstrap/carousel.js', '<%= meta.scripts %>libs/plugins/bootstrap/collapse.js', '<%= meta.scripts %>libs/plugins/bootstrap/dropdown.js', '<%= meta.scripts %>libs/plugins/bootstrap/modal.js', '<%= meta.scripts %>libs/plugins/bootstrap/tooltip.js', '<%= meta.scripts %>libs/plugins/bootstrap/popover.js', '<%= meta.scripts %>libs/plugins/bootstrap/scrollspy.js', '<%= meta.scripts %>libs/plugins/bootstrap/tab.js', '<%= meta.scripts %>libs/plugins/bootstrap/affix.js'],
    ...
    uglify: {
      ...
      dist: {
        files: [{
          '<%= meta.build %>js/modernizr.js': ['<%= meta.scripts %>libs/modernizr.2.8.3.js', '<%= meta.scripts %>libs/detectizr.js'],
          '<%= meta.build %>js/script.js': ['<%= meta.scripts %>l10n.js', '<%= meta.scripts %>libs/jquery-2.1.4.js', '<%= meta.scripts %>libs/handlebars-v4.0.5.js', '<%= meta.scripts %>libs/plugins/*.js', '<%= meta.scripts %>libs/plugins/bootstrap/transition.js', '<%= meta.scripts %>libs/plugins/bootstrap/alert.js', '<%= meta.scripts %>libs/plugins/bootstrap/button.js', '<%= meta.scripts %>libs/plugins/bootstrap/carousel.js', '<%= meta.scripts %>libs/plugins/bootstrap/collapse.js', '<%= meta.scripts %>libs/plugins/bootstrap/dropdown.js', '<%= meta.scripts %>libs/plugins/bootstrap/modal.js', '<%= meta.scripts %>libs/plugins/bootstrap/tooltip.js', '<%= meta.scripts %>libs/plugins/bootstrap/popover.js', '<%= meta.scripts %>libs/plugins/bootstrap/scrollspy.js', '<%= meta.scripts %>libs/plugins/bootstrap/tab.js', '<%= meta.scripts %>libs/plugins/bootstrap/affix.js', '<%= meta.scripts %>site.js', '<%= meta.scripts %>plugins/*.js']
        }]
      }
    },
    usemin: {
